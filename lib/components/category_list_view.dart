                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        Text(
                                          '${category['total_sessions'].toString()} sessions',
                                          textAlign: TextAlign.left,
                                          style: TextStyle(
                  ...
                  children: <Widget>[
                    ClipRRect(
                      ...
                      child: AspectRatio(
                        aspectRatio: 1.0,
                        child: Image.network(
                          category['courses_image'] != null
                              ? category['courses_image']
                              : 'http://159.65.154.185:89/storage/Hindi-Literature.jpeg', //placeholder image
                          fit: BoxFit.contain,
                        ),
                      ),
                    )
